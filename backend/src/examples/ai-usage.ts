...
async function exampleUsage() {
  ...
  try {
    const hashtagResult = await aiService.generateHashtags(
      'Amazing sunset at the beach with friends enjoying the golden hour',
      'instagram'
    );
  ...
  try {
    const validationResult = await aiService.validateContent(
      'This is a family-friendly post about nature and photography'
    );
