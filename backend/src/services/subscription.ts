...
export class SubscriptionService {
   ...
   */
  static async getUserSubscription(userId: number): Promise<{ user: User; subscription?: Subscription }> {
   ...
   */
  static async canGenerateContent(userId: number): Promise<{ canGenerate: boolean; reason?: string }> {
    ...
    const limit = SUBSCRIPTION_LIMITS[user.subscriptionTier as SubscriptionTier].monthlyPosts;
   ...
   */
  static async incrementUsage(userId: number): Promise<void> {
   ...
   */
  static async resetMonthlyUsage(userId: number): Promise<void> {
   ...
   */
  static async handleSubscriptionCreated(stripeSubscription: Stripe.Subscription): Promise<void> {
   ...
   */
  static async handleSubscriptionUpdated(stripeSubscription: Stripe.Subscription): Promise<void> {
    await db
