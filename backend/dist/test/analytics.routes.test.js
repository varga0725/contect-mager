...
describe('Analytics Routes', () => {
    ...
    beforeEach(async () => {
        ...
        for (const post of testPosts) {
            analyticsData.push({ postId: post.id, metricType: 'views', metricValue: 100 + Math.floor(Math.random() * 500) }, { postId: post.id, metricType: 'likes', metricValue: 10 + Math.floor(Math.random() * 50) }, { postId: post.id, metricType: 'shares', metricValue: Math.floor(Math.random() * 10) }, { postId: post.id, metricType: 'comments', metricValue: Math.floor(Math.random() * 20) });
        }
    ...
    describe('GET /api/analytics/overview', () => {
        ...
        it('should filter by platform', async () => {
            ...
            const instagramData = platformBreakdown.find((p) => p.platform === 'instagram');
...
//# sourceMappingURL=analytics.routes.test.js.map