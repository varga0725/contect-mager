...
describe('AI Service Retry Mechanism', () => {
    ...
    beforeEach(() => {
        ...
        aiService.geminiService = mockGeminiService;
        aiService.imagenService = mockImagenService;
        aiService.veoService = mockVeoService;
    });
    afterEach(() => {
        vi.restoreAllMocks();
    });
    describe('Successful Operations', () => {
        ...
        it('should log successful requests', async () => {
            ...
            await aiService.generateText({ prompt: 'Test prompt', platform: 'instagram' }, 123, 'req-456');
            expect(loggers.ai.request).toHaveBeenCalledWith(123, 'gemini', 'Test prompt', 'req-456');
            expect(loggers.ai.success).toHaveBeenCalledWith(123, 'gemini', expect.any(Number), 'req-456');
        });
    });
    describe('Retry Logic', () => {
        ...
        it('should log retry attempts', async () => {
            ...
            expect(loggers.ai.error).toHaveBeenCalledWith(123, 'gemini', expect.any(String), 'req-456');
        });
    ...
    describe('Timeout Handling', () => {
        it('should timeout long-running operations', async () => {
            mockGeminiService.generateContent.mockImplementation(() => new Promise(resolve => setTimeout(resolve, 2000)) // 2 seconds
            );
            try {
                await aiService.generateText({
                    prompt: 'Test prompt',
    ...
    describe('Configuration', () => {
        it('should respect custom retry configuration', async () => {
            ...
            customAiService.geminiService = mockGeminiService;
            const serverError = new Error('Server error');
            serverError.status = 500;
            mockGeminiService.generateContent.mockRejectedValue(serverError);
            try {
...
//# sourceMappingURL=ai-retry.test.js.map